...
class TestBaconComOvos(unittest.TestCase):
    ...
    def teste_bacon_com_ovos_deve_retornar_bacon_com_ovos_se_entrada_for_multiplo_de_3_e_5(self):
    ...
    def teste_bacon_com_ovos_deve_retornar_bacon_se_entrada_nao_for_multiplo_de_3(self):
    ...
    def teste_bacon_com_ovos_deve_retornar_ovos_se_entrada_nao_for_multiplo_de_5(self):
